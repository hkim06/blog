...
1. Realtime API (Speech-to-Speech Interactive)
...
2. Chained ASR + Responses/Chat Completions API + TTS (Non-Realtime Pipeline)
...
Send text to GPT (text model) for intent/action

Convert GPT’s text output to audio via audio/speech
